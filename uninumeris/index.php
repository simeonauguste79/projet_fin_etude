...
<hr class="style1">
    <!-- hr-------------------------------------------------------------------------------------------------- -->
    <section>
      <div class="video-center col-md-12 mb-5 ">
        <iframe class="media-object rounded-5" width="1050" height="350" src="https://www.youtube.com/embed/kDehTEEoFnE" frameborder="0" width="560" height="315" allowfullscreen></iframe>
      </div>
    </section>
    <!--hr-->
    <hr class="style1">
    <section class="article1">
      <h6 class="text-center">Article1</h6>
      <!--Carousel Wrapper-->
    ...
    <section class="article2">
      <h6 class="text-center">Article2</h6>
      <!-- Card -->
      ...
      <section class="row">
        <div class="col-lg-12">
          <p>
            ...
            <br> Je fais partie de la <abbr title="Société des Amoureux des Tigres">SAT</abbr> qui a pour but de faire connaître ces splendides animaux.
          </p>
